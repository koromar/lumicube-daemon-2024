    ...
    def rain(self):
        ...
        if update:
            ...
            for i in range(first, last + 1):
                ...
                sat = p.saturation  # + random.randrange(-35,36)/100
...
def BuildLookup():
    lookup = {
        (0, 7): (0, 8), (1, 6): (0, 9), (2, 5): (0, 10), (3, 4): (0, 11), (4, 3): (0, 12), (5, 2): (0, 13),
        (6, 1): (0, 14), (7, 0): (0, 15),
        (1, 7): (1, 8), (2, 6): (1, 9), (3, 5): (1, 10), (4, 4): (1, 11), (5, 3): (1, 12), (6, 2): (1, 13),
        (7, 1): (1, 14), (8, 1): (1, 15),
        (2, 7): (2, 8), (3, 6): (2, 9), (4, 5): (2, 10), (5, 4): (2, 11), (6, 3): (2, 12), (7, 2): (2, 13),
        (8, 2): (2, 14), (9, 2): (2, 15),
        (3, 7): (3, 8), (4, 6): (3, 9), (5, 5): (3, 10), (6, 4): (3, 11), (7, 3): (3, 12), (8, 3): (3, 13),
        (9, 3): (3, 14), (10, 3): (3, 15),
        (4, 7): (4, 8), (5, 6): (4, 9), (6, 5): (4, 10), (7, 4): (4, 11), (8, 4): (4, 12), (9, 4): (4, 13),
        (10, 4): (4, 14), (11, 4): (4, 15),
        (5, 7): (5, 8), (6, 6): (5, 9), (7, 5): (5, 10), (8, 5): (5, 11), (9, 5): (5, 12), (10, 5): (5, 13),
        (11, 5): (5, 14), (12, 5): (5, 15),
        (6, 7): (6, 8), (7, 6): (6, 9), (8, 6): (6, 10), (9, 7): (6, 11), (10, 6): (6, 12), (11, 6): (6, 13),
        (12, 6): (6, 14), (13, 6): (6, 15),
        (7, 7): (7, 8), (8, 7): (7, 9), (9, 7): (7, 10), (10, 7): (7, 11), (11, 7): (7, 12), (12, 7): (7, 13),
        (13, 7): (7, 14), (14, 7): (7, 15)
    }
    return lookup
...
def digitalrain(duration=RAIN_DURATION, delay=RAIN_DELAY):
    ...
    for s in range(0, maxStreams):
        streams.append(Stream(s, random.randrange(45, 66) / 100, random.randrange(35, 86) / 100, random.randrange(0, 3),
                              random.randrange(32, 43)))
