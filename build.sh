...
RUN mkdir -p /root/Downloads /root/java/x64 /root/java/arm /root/java/aarch64
...
RUN wget 'https://github.com/adoptium/temurin16-binaries/releases/download/jdk-16.0.2+7/OpenJDK16U-jdk_aarch64_linux_hotspot_16.0.2_7.tar.gz'
#RUN wget 'https://github.com/adoptium/temurin16-binaries/releases/download/jdk-16.0.2+7/OpenJDK16U-jre_aarch64_linux_hotspot_16.0.2_7.tar.gz'
...
RUN tar -xf OpenJDK16U-jdk_aarch64_linux_hotspot_16.0.2_7.tar.gz -C /root/java/aarch64
#RUN tar -xf OpenJDK16U-jre_aarch64_linux_hotspot_16.0.2_7.tar.gz -C /root/java/aarch64
...
RUN wget 'https://github.com/AppImage/AppImageKit/releases/download/13/runtime-aarch64'
...
RUN cp /root/Downloads/runtime-aarch64 /root/runtime-aarch64
...
for PLATFORM in "x64" "arm" "aarch64"
do
